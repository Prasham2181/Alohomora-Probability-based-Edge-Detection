...
from Network.Network import CIFAR10Model, ResNet,DenseNetCIFAR10,LeNet , ResNeXtCIFAR10
...
def main():
    ...
    transform_train = tf.Compose([tf.RandomCrop(32, 
                                padding=4,
